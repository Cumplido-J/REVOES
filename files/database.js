...
const getScripts = () => {
  ...
  filesToReturn.push({
    file: "./sisec.sql",
    content: fs.readFileSync("./sisec.sql").toString(),
  });
...
const execMenu = () => {
  ...
  rl.question(
    'Desea dropear (eliminar) la base de datos SISEC antes de continuar? \n -Escriba "eliminarSISEC" para eliminar la base de datos \n -Escriba "n", "N", "no" o "No" para no realizar esta acción \n> ',
    (response) => {

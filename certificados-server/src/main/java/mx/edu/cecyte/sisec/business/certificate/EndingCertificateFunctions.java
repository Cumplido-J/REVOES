...
import mx.edu.cecyte.sisec.classes.certificate.StudentEndingDecData;
import mx.edu.cecyte.sisec.classes.certificate.StudentEndingDecDataModule;
...
public class EndingCertificateFunctions {

    public static SigedFolioData getFolioDataFromXmlBytes(byte[] xmlBytes, String status) {
        Dec dec = EndingDecParser.xmlToClass(xmlBytes);
    ...
    public static CustomFile generateXmlFile(StudentEndingDecData studentData, AdminDecData adminDecData, Fiel fielBytes) {
    ...
    public static String generateXml(StudentEndingDecData studentData, AdminDecData adminDecData, Fiel fielBytes, String folioControl) {
        Dec dec = new Dec();
        dec.setVersion("3.0");
        ...
        for (StudentEndingDecDataModule module : studentData.getModules()) {
        ...
        String xmlString = EndingDecParser.classToXml(dec);
    ...
    public static EndingPdfData generatePdfData(byte[] xmlBytes, Date sinemsDate, boolean isPortability, DecreeSelect decree, ConfigPeriodData periodData) {
        Dec dec = EndingDecParser.xmlToClass(xmlBytes);
        return new EndingPdfData(dec, sinemsDate, isPortability, decree, periodData);
    }

...
public class Page3 extends EndingCertificateShared {
    private final EndingPdfData pdfData;
    private final SetFooterImage setFooterImage;

    public Page3(PdfResources pdfResources, EndingPdfData pdfData, Document document, SetFooterImage setFooterImage) {
    ...
    private void getTextParagraph() {
        ...
        Paragraph left2Container = PdfFunctions.createParagraph().add(left2Text).setTextAlignment(TextAlignment.JUSTIFIED).setMarginTop(5f);
        Paragraph left3Container = PdfFunctions.createParagraph().add(left3Text).setTextAlignment(TextAlignment.JUSTIFIED).setMarginTop(5f);
        Paragraph left4Container = PdfFunctions.createParagraph().add(left4Text).setTextAlignment(TextAlignment.JUSTIFIED).setMarginTop(5f);
        Paragraph left5Container = PdfFunctions.createParagraph().add(left5Text).setTextAlignment(TextAlignment.JUSTIFIED).setMarginTop(5f);
        Paragraph left6Container = PdfFunctions.createParagraph().add(left6Text).setTextAlignment(TextAlignment.JUSTIFIED).setMarginTop(5f);
        ...
        Paragraph right2Container = PdfFunctions.createParagraph().add(right2Text).setTextAlignment(TextAlignment.JUSTIFIED).setMarginTop(5f);
        Paragraph right3Container = PdfFunctions.createParagraph().add(right3Text).setTextAlignment(TextAlignment.JUSTIFIED).setMarginTop(5f);
        Paragraph right4Container = PdfFunctions.createParagraph().add(right4Text).setTextAlignment(TextAlignment.JUSTIFIED).setMarginTop(5f);
        Paragraph right5Container = PdfFunctions.createParagraph().add(right5Text).setTextAlignment(TextAlignment.JUSTIFIED).setMarginTop(5f);
        Paragraph right6Container = PdfFunctions.createParagraph().add(right6Text).setTextAlignment(TextAlignment.JUSTIFIED).setMarginTop(5f);

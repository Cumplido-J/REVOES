package mx.edu.cecyte.sisec.model.survey2021;
...
@Setter
@Entity
@Table(name = "encuesta_egresados_2021")
public class SurveyGraduated2021 {
    ...
    public SurveyGraduated2021(SurveyGraduated2021Request surveyRequest,Student student ){

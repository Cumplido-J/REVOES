...
public class Survey2021Logger {
    public static void saveSurvey(Logger log, String message, UserSession userSession, SurveyIntentions2021Request surveyRequest) {

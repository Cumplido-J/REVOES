...
public class Page1Temporary extends AbrogatedCertificateShared {
    private final AbrogatedPdfData pdfData;

    public Page1Temporary(PdfResources pdfResources, AbrogatedPdfData pdfData, Document document) {
    ...
    private void getHeadersParagraph() {
        ...
        String title5 = "";
        if (pdfData.isCecyte()) {
            title5 = pdfData.getEducationalOption() + "\n";
        } else if (pdfData.isEmsad()) {
            title5 = "Modalidad Mixta" + "\n";
        }
    ...
    private void getModuleParagraph() {
        ...
        Paragraph moduleContainer = PdfFunctions.createParagraph().add(moduleText).setTextAlignment(TextAlignment.JUSTIFIED).setMarginLeft(PdfFunctions.cmToPoints(0.7f));
        ...
        modulesTable.setWidth(PdfFunctions.cmToPoints(18.15f)).setMarginLeft(PdfFunctions.cmToPoints(0.7f));

...
public class SurveyGraduated2021Logger {
    public static void saveSurvey(Logger log, String message, UserSession userSession, SurveyGraduated2021Request surveyRequest) {

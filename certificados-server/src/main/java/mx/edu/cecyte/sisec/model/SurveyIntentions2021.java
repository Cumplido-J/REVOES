...
@Setter
@Entity
@Table(name = "encuesta_intenciones_2021")
public class SurveyIntentions2021 {
    ...
    public SurveyIntentions2021(SurveyIntentions2021Request surveyRequest, Student student) {

...
@NoArgsConstructor
@AllArgsConstructor
public class StudentEndingDecData {
    private String curp;
    private String name;
    ...
    private List<StudentEndingDecDataModule> modules;

...
class StoreCalificacionSemestralRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'grupo_recursamiento_semestral_id' => 'required|exists:grupo_recursamiento_semestral,id', 
    ...
    {
        return [
            'grupo_recursamiento_semestral_id.required' => 'El :attribute es obligatorio',
            'grupo_recursamiento_semestral_id.exists' => 'No fue posible asociar el :attribute con la calificación del alumno',
    ...
    public function attributes()
    {
        return [
            ...
            'grupo_recursamiento_semestral_id' => 'grupo recursamiento semestral',
            'plantel_id' => 'plantel',
            'grupoignacion_id' => 'docente',

...
class StoreConfigRecursamientoIntersemestralRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'recursamiento.*.id' => 'nullable|exists:config_recursamiento_intersemestral,id',
        ];
    }
    ...
    public function messages() 
    {
        return [
            ...
            'recursamiento.*.plantel_cct.exists' => 'No fue posible asociar el :attribute con la configuración de recursamiento intersemestral',

            'recursamiento.*.id.exists' => 'No fue posible asociar el :attribute con la configuración de recursamiento intersemestral',            
        ];
    }
    ...
    {
        $msg = $this->getMethod() === 'POST' ? 'No fue posible almacenar los datos de la configuración del recursamiento intersemestral' 
            : 'No fue posible modificar los datos de la configuración del recursamiento intersemestral';

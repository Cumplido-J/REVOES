...
class StoreCalificacionExtraordinarioRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'grupo_extraordinario_id' => 'required|exists:extraordinario,id', 
    ...
    {
        return [
            'grupo_extraordinario_id.required' => 'El :attribute es obligatorio',
            'grupo_extraordinario_id.exists' => 'No fue posible asociar el :attribute con la calificación del alumno',
    ...
    public function attributes()
    {
        return [
            ...
            'grupo_extraordinario_id' => 'grupo recursamiento semestral',
            'plantel_id' => 'plantel',

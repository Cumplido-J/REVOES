...
export default function DegreeQuerySincronize({ pendientBatches, sincronizeBatches, sincronizeResponse }) {
      ...
      {pendientBatches && (
        <Alert
          ...
          description={
            <>
              <p>
                No están actualizados los archivos con el servidor de titulación, favor de dar click en el siguiente
                botón
              </p>
              <ButtonCustom
                color="red"

  ...
  return (
    ...
    >
      <Table
        ...
        dataSource={students}
      />
      <Modal title="Confimación" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel} okText='Aceptar' cancelText='Cancelar' okButtonProps={{ style: { backgroundColor: primaryColor, borderColor: primaryColor, } }}>
